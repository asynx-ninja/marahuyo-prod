  ...
  return (
    ...
    >
      <div className="flex items-center flex-shrink-0 text-white">
        <span className="font-bold text-xl">MONTHLY SALES</span>
      </div>
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex">
          ...
          <button
            ...
            onClick={() => window.location.href = (`/print_monthly/${id}`)}
          >
            Export
          </button>
        </div>
...
export default MonthlySalesContent