    ...
    try {
      ...
      if (res.data.length !== 0) {
        bcrypt.compare(data.password, res.data[0].password, (err, result) => {
          if (err) {
            console.error(err);
          } else if (result && res.data[0].user_type === "customer") {
            setAlerts({
              success: {
                value: true,
            ...
            <form action="">
              ...
              <div className="flex flex-col justify-center items-center">
                <button
                  ...
                  className="w-[400px] text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
                >
                  Login
                </button>
              </div>
