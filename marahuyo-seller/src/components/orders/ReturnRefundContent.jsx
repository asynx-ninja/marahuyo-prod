    ...
    <div className="p-4">
      ...
      >
        <div className="flex items-center flex-shrink-0 text-white">
          <span className="font-bold text-xl">RETURNED ORDERS</span>
        </div>
      ...
      <div className="sm:container sm:mx-auto md:mx-auto px-4 py-8 overflow-x-auto">
        {/* <h2 className="text-2xl font-bold mb-4">Return Refund</h2> */}
        <div className="flex justify-between items-center mb-4">
          <div className="flex">
            ...
            <button 
              onClick={() => window.location.href = (`/print_return/${id}`)}
                ...
                data.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <select
                        className="inline-block py-1 px-3 text-xs font-semibold rounded-full bg-red-500 text-white"
                        name="status_name"
