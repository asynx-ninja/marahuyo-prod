...
const PrintToreceive = () => {
  ...
  const URL = (id) => {
    window.location.href = `/to_receive_orders/${id}`;
  };
  ...
  return (
    <div>
      ...
      <div ref={componentPDF} className="flex flex-col p-10 min-h-screen bg-gray-100">
        <div className="flex items-center justify-between w-full p-4">
          <div>
            <img src="/logo512.png" alt="Marahuyo Logo" className="w-24 mt-12 " />
          </div>
        ...
        <div className="mt-12">
        <p className="text-lg font-semibold">Shop Name: <span className="font-sans  font-normal">{shopData.shop_name}</span> </p>
          <p className="text-lg font-semibold">Username:  <span className="font-normal">{shopData.shop_username}</span> </p>
          <p className="text-lg font-semibold">Date:  <span className="font-normal">{currentDate}</span></p>
        </div>
