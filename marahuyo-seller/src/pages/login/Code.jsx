  ...
  return (
    <div className="flex">
      ...
      <div className="lg:w-6/12 h-screen flex flex-col items-center justify-center bg-white">
        ...
        <h1 className="sm:text-xl md:text-3xl font-bold text-center">
          Password Reset
        </h1>
        ...
        <form action="">
          <div className="grid grid-cols-6 md:gap-3 sm:gap-1 lg:mx-5">
            {[...Array(6)].map((_, index) => (
              <div className="relative z-0 w-full mb-6 group" key={index}>
                <input
                  ...
                  className="text-5xl text-center font-bold h-[7rem] rounded-lg block py-2.5 px-0 w-full text-gray-900 bg-transparent border-2 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-orange-500 focus:outline-none focus:ring-0 focus:border-orange-600 peer"
                  placeholder=" "
                  required
                />
              </div>
