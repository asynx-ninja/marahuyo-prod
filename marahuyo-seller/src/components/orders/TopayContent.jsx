    ...
    <div className="p-4">
      ...
      >
        <div className="flex items-center flex-shrink-0 text-white">
          <span className="font-bold text-xl">TO PAY ORDERS</span>
        </div>
      ...
      <div className="sm:container sm:mx-auto md:mx-auto px-4 py-8 overflow-x-auto">
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex">
            ...
            <button 
              onClick={() => window.location.href = (`/print_topay/${id}`)}
                ...
                data.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <select
                        className="inline-block py-1 px-3 text-xs font-semibold rounded-full bg-blue-500 text-white"
                        name="status_name"
