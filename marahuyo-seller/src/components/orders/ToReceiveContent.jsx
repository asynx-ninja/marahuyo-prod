    ...
    <div className="p-4">
      ...
      >
        <div className="flex items-center flex-shrink-0 text-white">
          <span className="font-bold text-xl">TO RECEIVE ORDERS</span>
        </div>
      ...
      <div className="sm:container sm:mx-auto md:mx-auto px-4 py-8 overflow-x-auto">
        {/* <h2 className="text-2xl font-bold mb-4">To Receive Orders</h2> */}
        <div className="flex justify-between items-center mb-4">
          <div className="flex">
            ...
            <button 
               onClick={() => window.location.href = (`/print_toreceive/${id}`)}
            ...
            {data.length !== 0 ? (
              data.map((item, idx) => (
                <tr key={idx} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td  className="px-6 py-4">
                    <select
                      className="inline-block py-1 px-3 text-xs font-semibold rounded-full bg-orange-500 text-white"
                      name="status_name"
                    ...
                    >
                      ...
                      <option
                        value="COMPLETED"
                        // selected={item.status_name === "COMPLETED"}
                      >
                        COMPLETED
                      </option>
                      <option
...
export default ToReceiveContent;
